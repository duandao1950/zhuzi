...
public class ZhuziFragmentWoMen extends SherlockFragment {
	
	public static ZhuziFragmentWoMen newInstance() {
		ZhuziFragmentWoMen fragment = new ZhuziFragmentWoMen();
		return fragment;
	}
